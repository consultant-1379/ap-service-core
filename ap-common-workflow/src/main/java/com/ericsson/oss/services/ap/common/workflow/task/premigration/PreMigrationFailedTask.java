 ...
 * updated to <b>PRE_MIGRATION_FAILED</b>.
 * <p>
 ...
 * <b>null</b>.
 */
public class PreMigrationFailedTask extends AbstractServiceTask {
    ...
    public void executeTask(TaskExecution execution) {
       ...
       final StateTransitionManagerLocal stateTransitionManager = serviceFinder
        ...
        final StateTransitionEvent event = StateTransitionEvent.PRE_MIGRATION_FAILED;
        ...
        commandRecorder.preMigrationFailed(workflowVariables);
    }
