...
/**
 * Unit tests for {@link EoiDataGenerationFailedTask}.
 */
@RunWith(MockitoJUnitRunner.class)
public class EoiDataGenerationFailedTaskTest extends AbstractFailedTaskTest {


        @InjectMocks
        private EoiDataGenerationFailedTask eoiDataGenerationFailedTask;
        ...
        public void whenOrderFailedAndRollbackWasSuccessfulThenApNodeStateChangesToOrderFailed() {
            ...
            eoiDataGenerationFailedTask.executeTask(execution);

            verify(stateTransitionManager, times(1)).validateAndSetNextState(NODE_FDN, StateTransitionEvent.EOI_INTEGRATION_FAILED);
        }
