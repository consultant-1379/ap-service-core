...
public class MigrationStartedTaskTest extends AbstractFailedTaskTest {

    @InjectMocks
    private MigrationStartedTask migrationStartedTask;
    ...
    @Test
    public void migrationStartedTask() {
        migrationStartedTask.executeTask(execution);
        verify(stateTransitionManager, times(1)).validateAndSetNextState(NODE_FDN, StateTransitionEvent.MIGRATION_STARTED);
    }
}
