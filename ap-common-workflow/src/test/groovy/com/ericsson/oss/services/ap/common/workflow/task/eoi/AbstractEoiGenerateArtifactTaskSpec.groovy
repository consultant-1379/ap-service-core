...
class AbstractEoiGenerateArtifactTaskSpec extends CdiSpecification{
    @Inject
    private TaskExecution execution;

    AbstractEoiGenerateArtifactTask abstractEoiGenerateArtifactTask = new AbstractEoiGenerateArtifactTask() {
    ...
    def "when generateArtifact task is triggered successfully"() {
        ...
        when: "invoking generateArtifact task"
        abstractEoiGenerateArtifactTask.executeTask(execution)
