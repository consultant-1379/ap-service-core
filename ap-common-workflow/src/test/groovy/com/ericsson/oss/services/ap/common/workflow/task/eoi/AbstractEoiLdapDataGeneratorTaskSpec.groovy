...
class AbstractEoiLdapDataGeneratorTaskSpec extends CdiSpecification {
    @Inject
    private TaskExecution execution;
    private AbstractWorkflowVariables workflowVariables ;


    AbstractEoiLdapDataGeneratorTask abstractEoiLdapDataGeneratorTask = new AbstractEoiLdapDataGeneratorTask() {
        @Override
        protected void eoiLdapDataGenerator(String nodeFdn,String baseUrl,String cookie) {
            return
        }
    }
    ...
    def "when LDap data generated successfully"() {
        ...
        when: "invoking Ldap data generation task"
        abstractEoiLdapDataGeneratorTask.executeTask(execution)
