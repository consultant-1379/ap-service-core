...
class AbstractEoiGenerateSecurityCredentialTaskSpec extends CdiSpecification{
    @Inject
    private TaskExecution execution;
    private AbstractWorkflowVariables workflowVariables ;

    AbstractEoiGenerateSecurityCredentialTask abstractEoiGenerateSecurityCredentialTask = new AbstractEoiGenerateSecurityCredentialTask() {
        @Override
        protected void eoiGenerateSecurityCredentials(String nodeFdn,String baseUrl,String cookieValue) {
           return
        }
    }
    ...
    def "when creating node user credentials success"() {
        ...
        abstractEoiGenerateSecurityCredentialTask.executeTask(execution)
