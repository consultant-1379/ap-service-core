...
public class ApApplicationException extends ApServiceException {
     ...
     */
    public ApApplicationException(final String message) {
        super(message);
    }
     ...
     *            the cause exception
     */
    public ApApplicationException(final Throwable exception) {
        super(exception);
    }
     ...
     *            the cause exception
     */
    public ApApplicationException(final String message, final Throwable exception) {
