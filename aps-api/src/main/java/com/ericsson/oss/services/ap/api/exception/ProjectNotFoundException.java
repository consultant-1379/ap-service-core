...
/**
 * Thrown to indicate that an AP project MO could not be found.
 */
public class ProjectNotFoundException extends ApApplicationException {

    private static final long serialVersionUID = -7801408861160774847L;

    private static final String PROJECT_NOT_FOUND_PROPERTY = "project.not.found.";
    ...
    public String getErrorPropertyName() {
        return PROJECT_NOT_FOUND_PROPERTY;
    }
}
