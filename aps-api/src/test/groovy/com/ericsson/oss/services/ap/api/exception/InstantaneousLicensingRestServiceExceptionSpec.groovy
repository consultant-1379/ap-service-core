...
/**
 * Unit tests for {@link InstantaneousLicensingRestServiceException}.
 */
class InstantaneousLicensingRestServiceExceptionSpec extends CdiSpecification {

    def "Check exception message sets correctly for new exception with message"() {
        when: "Exception created with message"
            Exception e = new InstantaneousLicensingRestServiceException("Exception message test")
    ...
    def "Check exception message and parent exception sets correctly for new exception with message and exception"() {
        ...
        Exception e = new InstantaneousLicensingRestServiceException("Exception message test", parentException)
