...
public interface FilterableComponent {
    ...
    /**
     * Creates the component. The component could for example be a Line or a Table etc. The result is a collection of <code>ViewProperties</code> which
     ...
     */
    Collection<ViewProperties> getClientDtos(final List<?> dataSource, final String dataType, final String moStruct, final String filter);
}
