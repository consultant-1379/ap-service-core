...
public class TextRendererFactory {
     ...
     * <p>
     * For example, a new instance of {@link CamelCaseTextSplitter} will be retrieved if the {@link Renderer#type()} parameter is equal to
     * <b>camel</b>.
     *
     * @param rendererType
    ...
    public TextRenderer getTextRenderer(final String rendererType) {
        for (final TextRenderer textRenderer : textRenderers) {
            ...
            textRenderers.destroy(textRenderer);
        }
        return null;
    }
}
