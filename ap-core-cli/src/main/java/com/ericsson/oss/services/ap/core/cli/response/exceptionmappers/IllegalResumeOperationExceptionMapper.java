 ...
 */
public class IllegalResumeOperationExceptionMapper implements ExceptionMapper<IllegalResumeOperationException> {
    ...
    @Override
    public CommandResponseDto toCommandResponse(final String command, final IllegalResumeOperationException e) {
