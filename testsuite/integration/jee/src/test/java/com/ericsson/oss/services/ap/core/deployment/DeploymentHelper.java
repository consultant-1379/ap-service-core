...
public class DeploymentHelper {
    ...
    /**
     * Get the dependencies that are identified in the given list of GAVs. GAV is GroupId, ArtifactId and Version as used in the maven pom.
     *
     * @param gavs
     * @return
     */
    ...
    /**
     * Get the dependency that is identified by the given GAV. GAV is GroupId, ArtifactId and Version as used in the maven pom.
     *
     * @param gav
     * @return
     */
    ...
    /**
     * Create and return a EAR Archive for the given name and GAV.
     *
     * @param name
     * @param gav
     * @return
     */
    protected static EnterpriseArchive getArchive(final String name, final String gav) {
        return ShrinkWrap
            .create(EnterpriseArchive.class, name)
     ...
     * @return
     */
    protected static WebArchive getWebArchive(final String name, final String gav) {
        return ShrinkWrap
    ...
    protected static String getVersion(final String key) {
    ...
    private static Collection<Resource> getResources() {
        ...
        final URL base = ServiceCoreDeployments.class.getResource("/content");
        appendFiles(CONTENT_ROOT, new File(base.getFile()), data);

        final URL arquillianXml = ServiceCoreDeployments.class.getResource(ARQUILLIAN_XML);
    ...
    private static Properties getProperties() {
        try {
            ...
            result.load(getResourceAsStream("%s", "ServiceFrameworkConfiguration.properties"));
    ...
    private static InputStream getResourceAsStream(final String formatter, final String resourceName) {
        final String actualResourceName = String.format(formatter, resourceName);
        return Thread.currentThread().getContextClassLoader().getResourceAsStream(actualResourceName);
    }
}
