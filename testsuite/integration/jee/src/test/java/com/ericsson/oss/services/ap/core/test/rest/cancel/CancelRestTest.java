 ...
 *******************************************************************************
 *----------------------------------------------------------------------------*/
package com.ericsson.oss.services.ap.core.test.rest.cancel;
...
public class CancelRestTest extends ServiceCoreTest {
    ...
    public void workflow_stubbed_message_correlation_exception(final String testType, final int nodeIndex, final int projectIndex) throws WorkflowMessageCorrelationException {
        if (testType.equals("success")){
            stubbedService.createApWorkflowServiceStub(true, "CANCEL");
        } else {
            stubbedService.createApWorkflowServiceStub(false, "CANCEL");
        }
    }
}
