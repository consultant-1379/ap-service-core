...
public final class DirectoryConfiguration {
    ...
    private static final String PROJECT_DIRECTORY = ARTIFACTS_DIRECTORY + "/%s";
    private static final String NODE_DIRECTORY = PROJECT_DIRECTORY + "/%s";
    ...
    private static final String PRECONFIG_DIRECTORY = ROOT_AP_SFS_DIRECTORY + "artifacts/preconfig";
     ...
     *
     * @return generated nodes directory
     */
    public static String getProjectDirectory(final String projectName) {
        return String.format(PROJECT_DIRECTORY, projectName);
    }
     ...
     * @return generated nodes directory
     */
    public static String getNodeDirectory(final String projectName, final String nodeName) {
        return String.format(NODE_DIRECTORY, projectName, nodeName);
    }
    ...
    /**
     * Gets the preconfig path that the netconf pre-configuration will be put in.
     *
     * @return artifacts preconfig directory
     */
    public static String getPreconfigDirectory() {
        return PRECONFIG_DIRECTORY;
    }
