...
public class EoiValidateNodeNameUniqueInApTest {
    ...
    @InjectMocks
    @Spy
    private EoiValidateNodeNameIsUniqueInAp eoiValidateNodeNameIsUniqueInAp;
    ...
    public void whenAllNodeNamesInProjectAreUniqueInApNamespaceThenReturnTrue() {
        ...
        final boolean result = eoiValidateNodeNameIsUniqueInAp.execute(context);
    ...
    public void whenSingleNodeNameInProjectIsNotUniqueInApNamespaceThenReturnFalse() {
        ...
        eoiValidateNodeNameIsUniqueInAp.execute(context);

        assertEquals(String.format("Node=%s already exists in project %s", NODE_NAME_2, PROJECT_NAME),
    ...
    public void whenMultipleNodeNamesInProjectAreNotUniqueInApNamespaceThenReturnFalse() {
        ...
        assertEquals(String.format("Node=%s already exists in project %s", NODE_NAME_2, PROJECT_NAME),
            context.getValidationErrors().get(0));
        assertEquals(String.format("Node=%s already exists in project %s", NODE_NAME_3, PROJECT_NAME),
